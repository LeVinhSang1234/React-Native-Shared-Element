# @rn-sanglv/react-native-shared-element
...
GitHub: [https://github.com/LeVinhSang1234/React-Native-Shared-Element/tree/share-video](https://github.com/LeVinhSang1234/React-Native-Shared-Element/tree/share-video)
...
```bash
npm install @rn-sanglv/react-native-shared-element
# or
yarn add @rn-sanglv/react-native-shared-element
```
...
If you want to enable auto-patching for React Navigation, please add the following to your app's `package.json`:

```json
"postinstall": "if [ -d ./node_modules/@react-navigation/core/lib/module ]; then cp ./node_modules/@rn-sanglv/react-native-shared-element/packages/auto-navigation.txt ./node_modules/@react-navigation/core/lib/module/useNavigation.js; fi"
```
...
```tsx
import {Video} from '@rn-sanglv/react-native-shared-element';
...
```tsx
import {ShareView} from '@rn-sanglv/react-native-shared-element';
...
### Preview
<video src="https://private-user-images.githubusercontent.com/35788280/489630407-24d59a51-fd69-41c0-b299-1e031c982607.mp4?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..cYSsLqqxH6COHohQiV2XlMTHlsaGL-RkuixrdyTmDxw" controls width="400"></video>
